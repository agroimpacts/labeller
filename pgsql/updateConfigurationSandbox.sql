...
UPDATE configuration SET value = '0.35' WHERE key = 'Consensus_RiskyPixelThreshold';
...
UPDATE configuration SET value = '10' WHERE key = 'Hit_AvailTarget';
...
UPDATE configuration SET value = '20' WHERE key = 'Hit_FqaqcPercentage';
-- Score a training HIT must achieve to be accepted.
UPDATE configuration SET value = '0.6' WHERE key = 'HitI_AcceptThreshold';
...
UPDATE configuration SET value = '0.65' WHERE key = 'HitN_TrustThreshold';
...
UPDATE configuration SET value = '0.6' WHERE key = 'HitQ_AcceptThreshold';
-- Percentage of HITs assigned to a worker that are to be Q HITs: default will be 20 in production.
UPDATE configuration SET value = '50' WHERE key = 'Hit_QaqcPercentage';
-- Score a QAQC HIT meeting the accept threshold must achieve for worker to be paid without a warning.
UPDATE configuration SET value = '0.62' WHERE key = 'HitQ_NoWarningThreshold';
...
UPDATE configuration SET value = '0.5' WHERE key = 'Hit_ReplacementThreshold_F';
...
UPDATE configuration SET value = '500' WHERE key = 'InitialFnum';
-- 
...
UPDATE configuration SET value = '2' WHERE key = 'MinimumMappedCount';
...
UPDATE configuration SET value = '0.25' WHERE key = 'ProportionHoldout';
-- The defined proportion of holdout1 in initial F sites in incoming_names
UPDATE configuration SET value = '0.25' WHERE key = 'ProportionHoldout1';
...
UPDATE configuration SET value = '10' WHERE key = 'StoppingFunc_MaxIterations';
