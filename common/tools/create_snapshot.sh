...
DATE="$(date +%Y-%m-%Y%t%T)"
echo "Snapshot created for $INAME at $DATE" >> snapshot_create.log
echo "Instance: $IID" >> snapshot_create.log
echo "Volume: $VID" >> snapshot_create.log
echo "Snapshot ID: $SNAPID" >> snapshot_create.log 
echo "" >> snapshot_create.log 
