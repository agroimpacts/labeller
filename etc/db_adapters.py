...
class DBAdapter(object):
    ...
    def __init__(self, db, UserClass, UserAuthClass=None, UserEmailClass=None, UserProfileClass=None, RoleClass=None, UserInvitationClass=None):
        self.db = db
...
class SQLAlchemyAdapter(DBAdapter):
    ...
    def __init__(self, db, UserClass, UserProfileClass=None, UserAuthClass=None, UserEmailClass=None, RoleClass=None, UserInvitationClass=None):
        super(SQLAlchemyAdapter, self).__init__(db, UserClass, UserAuthClass, UserEmailClass, UserProfileClass, RoleClass, UserInvitationClass)
