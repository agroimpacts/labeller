...
class UserMixin(LoginUserMixin):
    ...
    def get_roles(self):
        # Return role array if the user has roles. Return False otherwise.
    ...
    def has_role(self, *specified_role_names):
        ...
        user_role_names = self.get_roles()
        if not user_role_names: return False
